package GeekBrains.Multithreading.HomeTraining.ThreadJoinExample;
...
public class ThreadJoinExample {
    ...
    public static void main(String[] args) {
        ...
        //стартуем второй поток только после 2-секундного ожидания первого потока
        ...
        //даем всем потокам возможность закончить выполнение перед тем,
