...
public class MainApp {
    public static void main(String[] args) {
        ...
        // task one:
        GenericArray<Integer> intArray = new GenericArray<>(1, 2, 3, 4, 5);
        System.out.println(Arrays.asList(intArray.getArrayOfNumbers()));
        intArray.replaceObjects(3, 5);
        System.out.println(Arrays.asList(intArray.getArrayOfNumbers()));
        intArray.replaceObjects(3, 1);
        System.out.println(Arrays.asList(intArray.getArrayOfNumbers()));

        // task two:
        ArrayList<Integer> intList = intArray.arrayToList();
